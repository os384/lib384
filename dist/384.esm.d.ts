 ...
 */
	 ...
	 */
	reportMissingShard(hash: string): Promise<void>;
...
export declare class SBServiceWorker {
	 ...
	 */
	constructor(sbfs: SBFileSystem, messageHandler: (event: MessageEvent) => void, options?: {
		scope?: string;
		cacheName?: string;
	});
...
export declare const version = "0.20260409.0";

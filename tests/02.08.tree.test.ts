...
// tests deephistory algorithms in 'isolation' (not using the server).
// 'LocalTestDeepHistory' is a test class - the other two derived classes
// from DeepHistory are 'ClientDeepHistory' and 'ServerDeepHistory'.

...
// used to test DeepHistory, variation of 04.06 (but doesn't set TTL to 0)
...
// const COUNT = 128
// const COUNT = 7
// const COUNT = 512 * 32 * 32 // two levels
...
// also support matching 08.02 test cases
...
async function bench01(count: number, budgetKey?: SBUserPrivateKey): Promise<void> {
    ...
    // const msgOptions: MessageOptions = { ttl: 0 }; // not for this version
